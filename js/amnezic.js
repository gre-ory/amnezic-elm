		...
		return _elm_lang$core$Native_Utils.eq(model.state.page, target_page) ? A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _gre_ory$amnezic_elm$View$render_icon(icon_class),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(page_name),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A4(_gre_ory$amnezic_elm$View$render_nav_item, model, _gre_ory$amnezic_elm$Type$PageStart, 'reply', 'Start'),
							_1: {
								ctor: '::',
								_0: A4(_gre_ory$amnezic_elm$View$render_nav_item, model, _gre_ory$amnezic_elm$Type$PageThemes, 'sliders-h', 'Themes'),
								_1: {
									ctor: '::',
									_0: A4(_gre_ory$amnezic_elm$View$render_nav_item, model, _gre_ory$amnezic_elm$Type$PagePlayers, 'users', 'Players'),
									_1: {
										ctor: '::',
										_0: A4(_gre_ory$amnezic_elm$View$render_nav_item, model, _gre_ory$amnezic_elm$Type$PageQuestions, 'question', 'Question'),
										_1: {
											ctor: '::',
								...
								_0: A2(
									_elm_lang$html$Html$a,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_gre_ory$amnezic_elm$Type$MoveForward),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$title('Next step'),
													_1: {ctor: '[]'}
												}
											}
										}
									...
									{
										ctor: '::',
										_0: _gre_ory$amnezic_elm$View$render_icon('angle-right'),
										_1: {
											ctor: '::',
...
var _gre_ory$amnezic_elm$View$render_button = F4(
	function (icon_class, button_class, button_text, maybe_on_click) {
		...
		if (_p8.ctor === 'Just') {
			...
			return A2(
				_elm_lang$html$Html$button,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(
						A2(_elm_lang$core$Basics_ops['++'], 'button disabled ', button_class)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$title(button_text),
						_1: {ctor: '[]'}
...
var _gre_ory$amnezic_elm$View$render_previous_button = function (model) {
	...
	return A4(_gre_ory$amnezic_elm$View$render_button, 'angle-left', 'navigation previous', 'Previous', maybe_on_click);
};
