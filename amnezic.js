...
var _gre_ory$amnezic_elm$Type$State = F4(
	function (a, b, c, d) {
		return {page: a, question_id: b, step: c, media_status: d};
	});
...
var _gre_ory$amnezic_elm$Type$Player = F2(
	function (a, b) {
...
var _gre_ory$amnezic_elm$Type$StepEnd = {ctor: 'StepEnd'};
...
var _gre_ory$amnezic_elm$Type$StepReady = {ctor: 'StepReady'};
...
var _gre_ory$amnezic_elm$View$choice_style = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'background-color', _1: '#9aafc4'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'border', _1: '1px solid transparent'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'border-bottom', _1: '2px solid rgba(0, 0, 0, .3)'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'border-radius', _1: '6px'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: '-webkit-box-shadow', _1: '0 2px 3px rgba(0, 0, 0, .3)'},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'box-shadow', _1: '0 2px 3px rgba(0, 0, 0, .3)'},
										_1: {ctor: '[]'}
									}
								}
							}
...
var _gre_ory$amnezic_elm$View$render_choice = F3(
	function (state, choice_id, choice) {
		var choice_type = choice.correct ? 'correct' : 'distractor';
		var choice_class = A2(_elm_lang$core$Basics_ops['++'], 'choice ', choice_type);
		var _p0 = state.step;
		switch (_p0.ctor) {
			case 'StepNotReady':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class(choice_class),
						_1: {
							ctor: '::',
							_0: _gre_ory$amnezic_elm$View$choice_style,
							_1: {ctor: '[]'}
						}
					},
					{
			...
			case 'StepReady':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('question loaded...'),
						_1: {ctor: '[]'}
					});
				...
				return A2(
					...
					},
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(choice_type),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(' --- '),
									_1: {
...
var _gre_ory$amnezic_elm$View$render_question = F2(
	function (state, question) {
		var classes = _elm_lang$core$Native_Utils.eq(state.question_id, 1) ? 'question first' : 'question';
		return A2(
								...
								_0: A2(
									...
									_elm_lang$core$Array$toList(
										A2(
											...
											_gre_ory$amnezic_elm$View$render_choice(state),
											question.choices))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
...
var _gre_ory$amnezic_elm$View$render_questions = function (model) {
	var _p1 = A2(_elm_lang$core$Array$get, model.state.question_id, model.questions);
	if (_p1.ctor === 'Just') {
		return A2(_gre_ory$amnezic_elm$View$render_question, model.state, _p1._0);
	} else {
...
var _gre_ory$amnezic_elm$Main$init = {ctor: '_Tuple2', _0: _gre_ory$amnezic_elm$Update$init_model, _1: _elm_lang$core$Platform_Cmd$none};
